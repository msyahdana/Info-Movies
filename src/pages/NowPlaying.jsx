  ...
  useEffect(() => {
    async function getMovieList() {
      try {
        ...
        const response = await axios.get(`https://api.themoviedb.org/3/movie/now_playing?api_key=3372fc4e380b3c807cedb51e891bbc9d&page=${pageNumber}`);
        setNowPlayingMovieList(response.data.results);
      ...
      <Container>
        ...
        <Row>
          <Col className="d-flex flex-wrap justify-content-center">
            {nowPlayingMovieList?.map((movie, i) => (
