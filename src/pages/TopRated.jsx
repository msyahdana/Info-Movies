  ...
  useEffect(() => {
    async function getMovieList() {
      try {
        ...
        const response = await axios.get(`https://api.themoviedb.org/3/movie/top_rated?api_key=3372fc4e380b3c807cedb51e891bbc9d&page=${pageNumber}`);
